//
//  TCustomPicBrowserViewController.m
//  YKYClient
//
...
#import "TPictureCollectionCell.h"


@interface TCustomPicBrowserViewController ()<UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
...
@implementation TCustomPicBrowserViewController
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[TPictureCollectionCell class] forCellWithReuseIdentifier:@"cell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    TPictureCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
