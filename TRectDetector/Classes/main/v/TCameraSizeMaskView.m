...
@implementation TCameraSizeMaskView {
    BOOL _isDraw;
}
...
- (instancetype)initWithFrame:(CGRect)frame rulerTarget:(id)target action:(SEL)action {
    if (self = [super initWithFrame:frame]) {
        ...
        [_ruler setBackgroundImage:[UIImage bundleForImage:@"size_ruler"] forState:UIControlStateNormal];
        [_ruler setBackgroundImage:[UIImage bundleForImage:@"size_ruler"] forState:UIControlStateHighlighted];
...
//设置动画初始状态
- (void)setAnimationInitalStateWithView:(TCameraSizeBtn *)view {
...
//设置动画结束状态
- (void)setAnimationCompleteStateWithView:(TCameraSizeBtn *)view {
