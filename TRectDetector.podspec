...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TRectDetector.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/1370254410@qq.com/TRectDetector'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '1370254410@qq.com' => 'daitao@chaorey.com' }
  s.source           = { :git => 'https://github.com/1370254410@qq.com/TRectDetector.git', :tag => s.version.to_s }
